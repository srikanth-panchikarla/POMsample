...
* @ClassDescription 
* This Class is used to check Large business alert is created 
*  
...
* ================================================================================================================================================================================
* 01/06/2017                                1.0                          Sri Ram Kovvuri                            This Class is used to check Large business alert is created 
...
public class TestLargeBusinessAlert {
	WebDriver driver;
	...
	String sheetName = "LargeBusinessAlert";
	...
	/*
	 * This method is used to check Large business alert is created
	 */
	@Test(dataProvider = "Data")
	public void alertLargeBusiness(String Testcase, String AbnName, String FirstName, String MailId, String LastName,
			...
			String ConfirmPassword, String ServProvText, String adminUsername, String adminPassword) throws Exception {

		try {
			Log.info("******** :::: Inside the alertLargeBusiness :::::*********");
			...
			// String
			// businessMailID=activatebusinesspage.Reg_TextEmail.getAttribute("value");
			...
			activatebusinesspage.takeMeToYourAccountBtn.click();
			Thread.sleep(3000);
			...
			String largerEmployeeDescription = activatebusinesspage.myAlertDescription.getText();
			Boolean onlyEntity = largerEmployeeDescription.contains(entityName);
			Thread.sleep(2000);
			if (largerEmployeeDescription.contains(entityName)) {
			...
			Log.info("******** :::: End the alertLargeBusiness :::::*********");
		} catch (Exception e) {
