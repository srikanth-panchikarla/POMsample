...
* @ClassDescription 
* This Class is used to create business and allocate Service Provider Manually 
*  
...
* ================================================================================================================================================================================
* 01/06/2017                                1.0                          Sri Ram Kovvuri                            This Class is used to create business and allocate Service Provider Manually 
...
public class TestActivateBusinessPageManual {
	...
	String sheetName = "ActivateBusinessManual";
	...
	/*
	 * This Method is used to create business and allocate Service Provider
	 * Manually
	 */
	@Test(dataProvider = "Data")
	public void registerBusinessManual(String Testcase, String AbnName, String FirstName, String MailId,
			...
			String newPassword, String ConfirmPassword, String ServProvText) throws Exception {
		try {
			Log.info("******** :::: Inside the registerBusinessManual :::::*********");
			...
			Assert.assertEquals(
					...
					driver.getCurrentUrl());
			Log.info("******** :::: End  the registerBusinessManual :::::*********");
		} catch (Exception e) {
			Assert.assertEquals(true, false);
			Log.error("Exception Error in registerBusinessManual Method" + e);
		}
